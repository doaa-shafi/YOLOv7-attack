...
class ComputeLoss:
    ...
    def __call__(self, p, targets):  # predictions, targets, model
        ...
        lcls, lbox, lobj = torch.zeros(1, device=device,requires_grad=True), torch.zeros(1, device=device,requires_grad=True), torch.zeros(1, device=device,requires_grad=True)
